...
export class CreateBank1787412644065 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."banks_account_type_enum" AS ENUM('SAVING', 'CHECKING', 'INVESTMENT', 'PAYMENT')`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_banks_user_id_code" ON "banks"  ("user_id", "code") `);
        await queryRunner.query(`ALTER TABLE "banks" ADD CONSTRAINT "FK_bank_user_id" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "banks" DROP CONSTRAINT "FK_bank_user_id"`);
