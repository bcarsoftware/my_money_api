...
@InputType()
export class CreateOperationGenericBankInput {
  @Field(() => String)
  ...
  @IsOptional()
  @IsUUID("4", { message: "GenericBankBoxId must be a valid UUID." })
...
@InputType()
export class UpdateOperationGenericBankInput {
  @Field(() => String, { nullable: true })
  @IsOptional()
  @MaxLength(64, { message: "Tag must be at most 64 characters long." })
  tag?: string;
...
@InputType()
export class ListOperationGenericBankInput {
