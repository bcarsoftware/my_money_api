...
@InputType()
export class CreateOperationBankInput {
  @Field(() => String)
  ...
  @IsOptional()
  @IsUUID("4", { message: "BankBoxId must be a valid UUID." })
...
@InputType()
export class UpdateOperationBankInput {
  @Field(() => String, { nullable: true })
  @IsOptional()
  @MaxLength(64, { message: "Tag must be at most 64 characters long." })
  tag?: string;
...
@InputType()
export class ListOperationBankInput {
