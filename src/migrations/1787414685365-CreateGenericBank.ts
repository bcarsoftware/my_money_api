...
export class CreateGenericBank1787414685365 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "generic_banks" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "user_id" uuid NOT NULL, "bank_id" uuid, "name" character varying(64) NOT NULL, "currency" "public"."generic_banks_currency_enum" NOT NULL, "balance" numeric(10,2) NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_generic_bank_id" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    `);
    await queryRunner.query(`
      CREATE POLICY delete_generic_bank_logged_user ON generic_banks
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP POLICY IF EXISTS delete_generic_bank_logged_user ON generic_banks`
    );
