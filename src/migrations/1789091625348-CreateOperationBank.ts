...
export class CreateOperationBank1789091625348 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "operations_bank" ADD CONSTRAINT "FK_operation_bank_user" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "operations_bank" ADD CONSTRAINT "FK_operation_bank_bank" FOREIGN KEY ("bank_id") REFERENCES "banks"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "operations_bank" ADD CONSTRAINT "FK_operation_bank_bank_box" FOREIGN KEY ("bank_box_id") REFERENCES "bank_boxes"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "operations_bank" ADD CONSTRAINT "FK_operation_bank_invoice" FOREIGN KEY ("invoice_id") REFERENCES "invoices"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "operations_bank" DROP CONSTRAINT "FK_operation_bank_invoice"`
    );
    await queryRunner.query(
      `ALTER TABLE "operations_bank" DROP CONSTRAINT "FK_operation_bank_bank_box"`
    );
    await queryRunner.query(
      `ALTER TABLE "operations_bank" DROP CONSTRAINT "FK_operation_bank_bank"`
    );
    await queryRunner.query(
      `ALTER TABLE "operations_bank" DROP CONSTRAINT "FK_operation_bank_user"`
    );
